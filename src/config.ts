...
export const config: Readonly<AppConfig> = Object.freeze({
  ...
  segments: {
    ...
    maxSegmentGapBp: num('VITE_DEFAULT_MAX_SEGMENT_GAP_BP', DEFAULT_SEGMENT_PARAMS.maxSegmentGapBp),
    maxSegmentGapCm: num('VITE_DEFAULT_MAX_SEGMENT_GAP_CM', DEFAULT_SEGMENT_PARAMS.maxSegmentGapCm),
