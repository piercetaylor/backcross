/**
 * Built-in crop chromosome schemes (contract/data-contract.md 1.5.0,
 * "Chromosome names"; contract/crops/; docs/adr/0020).
 *
 * Responsibility: the nine schemes shipped under contract/crops/, the schema
 ...
 * sorghum, wheat, barley, oat, common-bean, cotton), DEFAULT_CROP_ID,
 * validateScheme(value) -> CropScheme (throws "crop scheme: <reason>"),
 * resolveCrop(id) -> CompiledScheme (undefined -> soybean; an unknown id
 * throws naming the built-ins).
 */
...
export const BUILTIN_CROPS: ReadonlyMap<string, CropScheme> = new Map(
  [soybean, maize, rice, sorghum, wheat, barley, oat, commonBean, cotton].map((json) => {
