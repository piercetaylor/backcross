...
Deferred past M3, in rough order of value: WCAG 2.2 target-size on the gutter buttons (2.5.8; the Equivalent exception arguably applies through the Lines rows, which axe cannot see); the vendor chunk split (docs/adr/0010); the contract items PLAN.md lists under "Deferred, 2026-09-14"; contract 1.3.0.
